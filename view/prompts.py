...
def do_convert(is_already_mp3=False) -> bool:
    '''Prompt user to make a conversion decision'''

    if is_already_mp3:
        print("Change MP3 bitrate?")
    else:
...
def show_settings() -> None:
    '''Settings Menu'''
    print("\nSettings:")
    print("Choose an item to edit:\n\t1.) CDROM Drive - Select and save a drive to rip from, if any.\n\t2.) Odno Save Location - Where tracks are saved after conversions.")