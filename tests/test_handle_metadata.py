...
import cd_ripper.handle_metadata as handle_metadata
...
@patch('cd_ripper.handle_metadata.Song')
...
#TODO:
#@pytest.mark.parametrize("album_name, artist_name, album, resp, expected_count, expected_song_attr",[])
#@patch('cd_ripper.handle_metadata.Song')
#def test_manual_search_gets_track_list(mock_song_class, album_name, artist_name, resp, expected_count, expected_song_attr):